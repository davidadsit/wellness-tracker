...
describe('tagsSlice', () => {
  ...
  describe('fetchAllTags', () => {
    it('sets loading true on pending', () => {
      const state = tagsReducer(
        initialState,
        fetchAllTags.pending('', undefined),
      );
    ...
    it('stores categories and tags on fulfilled', () => {
      const categories = [
        {id: 'c1', name: 'Mental', sortOrder: 1, isDefault: true, createdAt: 0},
      ];
      const tags = [
        {
          id: 't1',
  ...
  describe('updateTag', () => {
    it('updates label in state on fulfilled', () => {
      ...
      const state = tagsReducer(
        stateWithTag,
        updateTag.fulfilled({id: 't1', label: 'New Label'}, '', {
          id: 't1',
          label: 'New Label',
        }),
      );
