...
const styles = StyleSheet.create({
  ...
  buttons: {flexDirection: 'row', justifyContent: 'flex-end', marginTop: 24, marginBottom: 40},
  cancelBtn: {paddingHorizontal: 20, paddingVertical: 12, marginRight: 12},
  cancelBtnText: {fontSize: 16, color: '#888'},
  submitBtn: {
    paddingHorizontal: 24, paddingVertical: 12, backgroundColor: '#4A90D9', borderRadius: 8,
  },
